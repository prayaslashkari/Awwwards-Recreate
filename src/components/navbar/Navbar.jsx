...

            {
                ...
                <div className= {styles.left}>
                    <div onClick={props.wierd} id={styles.clickable} className={styles.alpha}>
                        ...
                        <span id={styles.menuid}>MENU</span> 
                    </div>      
                </div>
                ...
                <div className={styles.rightright}>
                {
                    ...
                    (<div className={styles.gamma}>
                        <div className={styles.gammafield}>
                            <input placeholder="SEARCH FOR INSPIRATION (HTML5, VR, RED, MINIMAL)" type="text"/>
                        </div>
                    ...
                    <div onClick={()=>{setToggle(!toggle)}} className={styles.beta}>
                       <img id={styles.betaid2} src="https://img.icons8.com/ios-filled/15/000000/search.png"/>  
                    </div> 
                    ...
                    <div className= {styles.right}>
                        <div className={styles.onebutton}> 
                            <span className={styles.quetext}> ARE YOU A MEMBER?</span> 
                            <a className={styles.register} href="#"> REGISTER/LOG IN</a>
                        </div>

                        <div onClick={()=>{setToggle(!toggle)}} id={styles.betaid} className={styles.beta}>
                            <img src="https://img.icons8.com/ios-filled/15/000000/search.png"/>  
                        </div> 

                        <div id={styles.buttonid} className={styles.twobutton}><a className={styles.submit} href="">SUBMIT YOUR SITE!</a></div>
                    </div>
